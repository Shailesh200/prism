...
| M-043 UI Fine-Tuning | `milestone/M-043-ui-finetune` | In Progress | ☐ | ☐ | Started 2026-07-22: card explain tooltips, landing auto-detect + Start Indexing, Recent Activity (local/pushed/last-synced), Google Stitch prompts + dark DESIGN.md; Codebase DNA screen built (real getDna); Backend screen + Wave-1 enrichment; Domains explorer + Web/DevOps/Mobile/Desktop domains; Blast Radius screen wired to Core impact contracts (M-020/M-021); Trends screen (live git charts + honest empty health history); Integrations screen (local-first + honest Available/Soon cards); Settings screen (workspace/re-index/map/privacy); Audit Logs (session-local trail of real Core API calls) |
...
| M-025 Core SDK Freeze v0 | `milestone/M-025-core-sdk-freeze` | Not Started | ☐ | ☐ | |
...
| M-030 VS Code Shell | `milestone/M-030-vscode-shell` | Not Started | ☐ | ☐ | |
| M-031 VS Code Features | `milestone/M-031-vscode-features` | Not Started | ☐ | ☐ | |
| M-032 Cursor Extension | `milestone/M-032-cursor-extension` | Not Started | ☐ | ☐ | |
