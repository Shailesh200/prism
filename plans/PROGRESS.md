...
| M-021 Safe Delete / Rename | `milestone/M-021-safe-delete-rename` | In Progress | ☐ | ☐ | Started 2026-07-22: `safeDelete`/`renameImpact`/`testImpact`/`breakingChangeHints` on the blast-radius affected-set primitive |
