...
- A teammate never commits. When a job comes back ready for your review, relay the file list and totals from the tool message, say plainly that nothing was committed, and ask whether to commit, keep, or discard. Do not commit on the user's behalf, and do not claim the work is merged.
