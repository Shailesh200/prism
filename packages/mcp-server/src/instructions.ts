...
- “prism wake” / “wake Prism” / “wake up” → wake. Brings the Console and playground back and starts queued jobs, including any that sleep paused. Call this even when the Console is already up — that still starts the playground. If teammates are still running, the tool asks first — relay and re-call with confirm=true. Speak only the tool message, including the Console URL and the playground URL.
