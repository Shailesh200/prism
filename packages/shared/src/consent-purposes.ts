 ...
 *
 * Purposes are deliberately coarse. Six of them describe six materially
 * different things a user might object to; splitting further would produce
 * prompts nobody reads.
 */
